/**
 * Auto-Generated using http://jsongen.byingtondesign.com/
 */
package com.digitalbuddha.rank.model;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;

@JsonIgnoreProperties(value = "private")
public class Repository {
   	...
   	private Number open_issues;
   	private Number open_issues_count;
   	private Owner owner;
	...
	public void setForks(Number forks){
 	...
 	public Number getForks_count(){
		return this.forks_count;
	}
	public void setForks_count(Number forks_count){
	...
	public void setNotifications_url(String notifications_url){
 	...
 	public Number getOpen_issues(){
		return this.open_issues;
	}
	public void setOpen_issues(Number open_issues){
		this.open_issues = open_issues;
	}
 	public Number getOpen_issues_count(){
		return this.open_issues_count;
	}
	public void setOpen_issues_count(Number open_issues_count){
	...
	public void setWatchers(Number watchers){
 	...
 	public Number getWatchers_count(){
    ...
    public void setPulls(Pull[] pulls) {
        this.pulls = pulls;
    }
